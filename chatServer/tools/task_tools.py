...
class GetTasksTool(BaseTool):
    ...
    def prompt_section(cls, channel: str) -> str | None:
        ...
        if channel in ("web", "telegram"):
            return "Tasks: Check get_tasks at conversation start to see what the user is working on. When they mention something actionable, use create_task. Update status as work progresses."
