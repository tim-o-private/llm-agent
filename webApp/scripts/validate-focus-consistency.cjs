...
const ALLOWED_MANUAL_FOCUS_FILES = [
  'src/utils/focusStates.ts', // The focus system itself
  'src/styles/ui-components.css', // Global CSS
  'src/components/ui/toast.tsx', // Complex toast component
];
...
function findTsxFiles() {
  return glob.sync('src/**/*.{tsx,ts}', {
    ignore: ['src/**/*.test.{tsx,ts}', 'src/**/*.spec.{tsx,ts}']
  });
}
