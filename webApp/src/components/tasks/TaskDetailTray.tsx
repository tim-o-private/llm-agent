      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div>
          ...
          <select 
            ...
            className="w-full mt-1 block pl-3 pr-10 py-2 text-base border-ui-border focus:outline-none focus:border-ui-border-focus focus:ring-2 focus:ring-accent-subtle sm:text-sm rounded-md bg-ui-surface text-text-primary"
          >
        ...
        <div>
          ...
          <textarea // Changed to HTML textarea
            ...
            className="w-full mt-1 block pl-3 pr-3 py-2 text-base border-ui-border focus:outline-none focus:border-ui-border-focus focus:ring-2 focus:ring-accent-subtle sm:text-sm rounded-md bg-ui-surface text-text-primary shadow-sm" // Added common input styling + shadow-sm
            rows={4}
          />
        </div>
