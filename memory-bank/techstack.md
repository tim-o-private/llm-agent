...
* `config/`: Static application and agent configuration files.
* `data/`: Dynamic runtime data (global context, agent memory, agent output files).
* `src/`: Python source code (core: agent_loader, context_manager, llm_interface, file_parser; cli: main; utils: config_loader, path_helpers, chat_helpers).
