...
- `memory-bank/clarity/state-management-design.md` - Full design document
- `memory-bank/clarity/state-management-example.ts` - Reference implementation
- `memory-bank/clarity/state-management-component-example.tsx` - Component integration example
