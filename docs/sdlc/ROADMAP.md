...
|----|---------|--------|------|
| SPEC-001 | Notification System | In progress (uncommitted) | [SPEC-001](specs/SPEC-001-notification-system.md) |
| SPEC-002 | Telegram Integration | In progress (uncommitted) | [SPEC-002](specs/SPEC-002-telegram-integration.md) |
| SPEC-003 | Scheduled Agent Execution | In progress (uncommitted) | [SPEC-003](specs/SPEC-003-scheduled-execution.md) |
